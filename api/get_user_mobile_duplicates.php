...
$sql = "SELECT mobile, COUNT(mobile) AS count
        FROM tbl_users
        WHERE mobile != '' AND active = '0' AND is_deleted = '1' AND blocked = '0'
        GROUP BY mobile ";
            ...
            if ($array['count'] > '1') {
                ...
                $mobile = $array['mobile'];
                  ...
                  $sql2 = "SELECT m.*, s.name AS state_name, c.name AS city_name, u.name AS country_name 
                           ...
                           WHERE m.mobile = '$mobile' AND m.active = '0' AND m.is_deleted = '1' AND m.blocked = '0'";         
