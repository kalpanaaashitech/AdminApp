...
$limitid = $_GET['id'];
	...
	$sql = "SELECT m.*, u.first_name, u.last_name, u.image as user_image
	        ...
	        WHERE m.post_type = '9' AND m.active = '0'  
		    ORDER BY m.id DESC LIMIT ".$limitid.",12"; 
    ...
    while ($row = $result->fetch_assoc())
    {
        ...
        { 
        	$img_fet = array_map('utf8_encode', $img_fet);
			...
			$option_id = $img_fet['id'];
				...
				{
					$img_sup_fet = array_map('utf8_encode', $img_sup_fet);
					$image_array['supports'][] = array(
							'id' => $img_sup_fet['id'],
				...
				$img_opi = "SELECT c.id, c.option_id, c.opinions, u.first_name, u.last_name, u.image as user_image
				FROM `tbl_what_post_images` AS m 
        ...
        {
        	$ans_fet = array_map('utf8_encode', $ans_fet);
            $row_array['answers'][] = array(
					'id' => $ans_fet['id'],
	...
	$sql3 = "SELECT *
        ...
        {  
        	$com_fet = array_map('utf8_encode', $com_fet);
			...
			{
				$comment_users_fet = array_map('utf8_encode', $comment_users_fet);
				$comment_array['comment_users'][] = array(
        ...
        {
        	$cat_fet = array_map('utf8_encode', $cat_fet);
			$row_array['category'][] = array(
			'id' => $cat_fet['id'],
        ...
        {
        	$post_ques_fet = array_map('utf8_encode', $post_ques_fet);
			...
			{ 
				$qus_img_fet = array_map('utf8_encode', $qus_img_fet);
				$question_array['images'][] = array(
					'id' => $qus_img_fet['id'],
		...
		$sql6 = "SELECT e.*, u.first_name, u.last_name, u.image as user_image
			...
			{
				$post_opi_fet = array_map('utf8_encode', $post_opi_fet);
		...
		{
			$ques_follow_fet = array_map('utf8_encode', $ques_follow_fet);
			$row_array['question_user_follow'][] = array(
		...
		{
			$post_tryit_fet = array_map('utf8_encode', $post_tryit_fet);
			...
			{ 
				$tryit_img_fet = array_map('utf8_encode', $tryit_img_fet);
				$tryit_array['images'][] = array(
					'id' => $tryit_img_fet['id'],
		...
		$sql9 = "SELECT e.*, u.first_name, u.last_name, u.image as user_image
			...
			{
				$post_mus_fet = array_map('utf8_encode', $post_mus_fet);
